...
{
$sql=mysqli_query($con,"SELECT password FROM  users where password='".$password."' && id='".$_SESSION['id']."'");
$num=mysqli_fetch_array($sql);
if($num>0)
{
 $con=mysqli_query($con,"update students set password='".$password."', updationDate='$currentTime' where id='".$_SESSION['id']."'");

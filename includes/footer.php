...
<h3>Browse & Buy</h3>
     ...
     <div class="module-body m-t-20">
        <p class="about-us"> Embrassant chaque instant, nous façonnons un avenir où choisir librement notre chemin devient le pilier de notre existence, en quête d'harmonie pour soi et pour autrui..</p>
        ...
        <ul class="toggle-footer" style="">
            <li class="media">
              ...
              <li class="media">
                ...
                <div class="media-body">
                    <p>00-000000-00<br>0-00-000000-000</p>
                </div>
            </li>
